...
|ManagingCustomerId|Equals|Use this field to search the ManagingCustomerId element of the [ClientLink](clientlink.md). If other customers also link to the client ad account, the results will include those client links. This predicate value is deprecated in favor of the DirectManagingCustomerId predicate.|
