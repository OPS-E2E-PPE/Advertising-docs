...
|-----------|---------------|-------------|
|<a name="alternativetext"></a>AlternativeText|Alternative description of the image media for usability. If the image could not be displayed, the alternative text is used instead.<br/><br/>The maximum length for this element is 35 characters.<br/><br/>**Add:** Required<br/>**Update:** Optional|**string**|
...
|<a name="finalappurls"></a>FinalAppUrls|Not supported for image ad extensions.|[AppUrl](appurl.md) array|
|<a name="finalmobileurls"></a>FinalMobileUrls|Not supported for image ad extensions.|**string** array|
|<a name="finalurls"></a>FinalUrls|Not supported for image ad extensions.|**string** array|
