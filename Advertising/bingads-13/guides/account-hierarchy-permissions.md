...
> 
> In the context of hierarchies a [Customer](../customer-management-service/customer.md) is also known as a "Manager account" and an [AdvertiserAccount](../customer-management-service/advertiseraccount.md) is also known as an "Ad account". 
> 
...
For users in an [account hierarchy](#account-hierarchy), the Standard user role is further refined by the link permission i.e., [CustomerLinkPermission](../customer-management-service/customerrole.md#customerlinkpermission). 
